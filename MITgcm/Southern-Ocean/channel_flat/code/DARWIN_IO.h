C $Header: /u/gcmpack/MITgcm_contrib/darwin2/pkg/darwin/DARWIN_IO.h,v 1.4 2011/09/22 19:23:31 jahn Exp $
C $Name:  $
...
c    inputDust      - dust deposiation at surface
c    sur_par        - surface PAR
      COMMON /DARWIN_INPUT/
     &       fice, inputFe, inputDust, sur_par
#ifdef NUT_SUPPLY
     &      ,nut_wvel
#endif
#ifdef RELAX_NUTS
...
c
       ...
       _RL   inputDust(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx, nSy)
